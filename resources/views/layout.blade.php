  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        @auth
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('/posts/create') ? 'active' : '' }}" href="/posts/create">Create Blog</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('register') ? 'active' : '' }}" href="/register">Regsiter</a>
        </li>
        @endauth
